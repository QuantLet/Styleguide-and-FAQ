...
```
How to include the apostrophe character inside your text. Very important: use TWO single quotes signs ('') and NOT ONE double quote sign("), because the both ways look nearly the same !
