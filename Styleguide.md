...
```
How to include the apostrophe character inside your text. Very important: use TWO single quotes signs (Type ', Type ') and NOT ONE double quote sign(Type "), because the both ways look nearly the same !
