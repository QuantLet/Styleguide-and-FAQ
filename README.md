...
[<img src="https://github.com/QuantLet/Styleguide-and-Validation-procedure/blob/master/pictures/banner.png" width="880" alt="Visit QuantNet">](http://quantlet.de/index.php?p=info)
...
- Validation procedure for those who are assigned to quality assurance (is of a complementary nature, the aforementioned Styleguide has priority over it and is kept up-to-date continuously) - [Validation procedure](https://github.com/QuantLet/Styleguide-and-Validation-procedure/blob/master/Validation%20procedure.pdf)
