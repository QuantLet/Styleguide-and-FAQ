...
\begin{enumerate}[label*=\arabic*.]
	...
	\end{enumerate}
	\item \textbf{Check all items of MetaInfo.txt} for order, completeness and correctness [optional items are written 	in \textit{italic}] - \label{MetaInfo-ini}\hyperref[MetaInfo]{Click to see example}
	\begin{enumerate}[label*=\arabic*.]
